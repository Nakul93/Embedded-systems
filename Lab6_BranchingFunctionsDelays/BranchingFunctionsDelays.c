...
int main(void){ 
  ...
  while(1){
    // body goes here
		...
		if( input == 0)//switch is pressed, toggle the led
		{
			GPIO_PORTF_DATA_R ^= 0x04;
		}
		else //switch is not pressed, turn on the led
		{
			GPIO_PORTF_DATA_R |= 0x04;
		}
  }
